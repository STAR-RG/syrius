...
pdf("scripttag.pdf", width = 6.5, height = 2.9)
...
df7 <- read.table("data23.txt", header = FALSE)
...
bp <- boxplot(df1$V1,df2$V1,df3$V1,df4$V1,df5$V1,df6$V1,df7$V1,names=c("1","2","3","4","5","10","23"), boxwex=0.2, cex.axis=1, las=1)
