...
\begin{table*}[t!]
  ...
  \caption{\label{table:attacks}List of attacks. Non-http attacks
    appear at the top andcontent-based http attacks appear at the bottom.}
  \centering
  \begin{tabular}{llllp{10cm}}
    ...
    WeBid \MyComment{Local File Inclusion} & \cite{nikto} & LFI & HTTP & \textbf{content}:"GET "; depth:4; \textbf{content}:"/cron.php?"; http\_uri; nocase; \textbf{content}:"include\_path="; http\_uri; nocase; \textbf{content}:"../"; \\
...
access point to the Internet. We also used the 
