...
characteristics. \tname\ performed very well, being capable of
generating the correct rule among the top-3 and top-1 rules of the
ranking, respectively, in \percTopThreeRankingPrefix\ and
\percTopOneRankingPrefix\ of the cases.
\end{abstract}
...
%We ran \tname{} using different combinations of weights on a sample of
