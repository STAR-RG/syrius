...
protocol. \Luc{The attacker sends a set of ICMP Echo requests to a network of machines and sees which one responds to the request. This allow the attacker to know which machines are active in the network, then it can choose one of them to attack.}
