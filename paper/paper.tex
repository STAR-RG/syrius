...
\begin{table*}[t!]
  ...
  \begin{tabular}{lllp{11cm}}
    ...
    ColdFusion \MyComment{Privilege Escalation} & Privilege Escalation & HTTP \MyComment{& Privilege Escalation} & \textbf{content}:"GET"; http\_method; nocase; \textbf{content}:"/CFIDE/administrator"; http\_uri; nocase; \\
