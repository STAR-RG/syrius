...
Table~\ref{table:attacks}, we configured an http server (Apache2) and
ran a security tool to attack that server. Simultenously, we ran
...
encoded in Nikto2\Mar{@Lucas, diga exatamente como vc. obtem as
  variacoes. isto eh que eh importante para a proxima sentenca.}. rq3 evaluates the importance of these variants to
