...
procedure described on Section~\Fix{xxx}.
...
Table~\Fix{xxx}). The remaining columns show results supressing one
...
\begin{figure}[t!]
\centering
\includegraphics[scale=0.4]{R/time.pdf}
\vspace{-2ex}
\caption{Impact of number of positive examples used for synthesis.}
