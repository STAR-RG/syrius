...
\documentclass[sigconf,anonymous,pre-print]{acmart}
...
fields. Handling this case is critically important as \Fix{xx}\% of
  ...
  \scalebox{1.2}{  
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot coordinates {(1,10222) (2,4956) (3,5589)
...
(\Fix{xx}\%) and half of the rules contain at least two
