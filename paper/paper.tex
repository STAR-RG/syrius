...
the option \CodeIn{windows: 512} is not included in the golden rule
...
\begin{figure}[h]
  \vspace{-2ex}
  \lstinputlisting[language=C,numbers=none,frame=none,keywords={flags,threshold,window,icmp\_id,icmp\_seq}]{synflood-top5-rules.suricata}
  \vspace{-3ex}  
\end{figure}
...
\begin{table*}[h!]
  ...
  \begin{tabular}{lllp{11cm}}
    ...
    - & - & HTTP \MyComment{& \Luc{Adicionar}} & \textbf{content}:".htaccess"; nocase; http\_uri; \\
    \bottomrule
  \end{tabular}
\end{table*}
