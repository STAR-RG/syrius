...
%          axis equal,
          ...
          every node near coord/.append style={font=\scriptsize},
          nodes near coords align={vertical},
          symbolic x coords={method, uri, user\_agent, header, host, connection, request\_line},          
        ]
        \addplot coordinates {(method,3821) (uri,10111) (user\_agent,1022) (header,4089) (host,224) (connection,29) (request\_line,11)};
      \end{axis}
    \end{tikzpicture}
  }
  \vspace{-2ex}
