...
Table~\ref{table:weights} shows the results, where ``Name'' is the
name of the attack and ``base'' is the result of
\tname\ with all heuristic functions enabled, as in ``Rank
(step 3)'' in Table~\ref{table:results}. The remaining columns show
...
configuration is worse when compared to ``base''. A down arrow ($\downarrow$), 
