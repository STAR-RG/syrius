...
Note from the figure that the negative traffic is an input to the
technique. The positive traffic, in contrast, is not. \tname{} uses
public databases storing different kinds of positive traffic for all
protocols covered by Suricata. \Fix{what databases?}
...
We also used normal pcaps from Stratosphere Lab on https://www.stratosphereips.org/datasets-normal to verify if Suricata's ET rules weren't catching positive flow. }
