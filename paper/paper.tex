...
in the reported ranking.  Column ``\#~Vars.''  shows the number of
variants of a given attack. The other data that \tname\ depends upon
are not mentioned as they are constant. The rest of the columns show
the progress of the tool at various stages and provide an indication
of complexity of the synthesis problem.
