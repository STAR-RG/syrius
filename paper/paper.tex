...
rules we used\Mar{reference}. Note that rules with 1 to 3 options are
more common.  At the end of the process, \tname{} ranks the golden
rule at the top of the ranking including \Fix{XXXXXX} other plausible
rules.
