...
\begin{figure}[h!]
  ...
  \caption{The \tname\ workflow.\Mar{revisar}}
  \label{fig:overview}
  \vspace{-2ex}
\end{figure}
...
\subsection{Step 2: Rule Creation}
...
\begin{algorithm}[t!]
  %\noindent\hspace{-2ex}
  \flushleft{}\textbf{INPUT:} (overconstrained) seed rule $sr$, bening traffic
  $\mathit{bTr}$, malli-\\
  cious traffic $\mathit{mTr}$\\
...
takes as input an overconstrained rule $sr$, produced by the reverse
engineering step, and produces on output a set of alternative rules to
$sr$ that captures every instance of the attack ($\mathit{mTr}$), but
does not capture any message from the benign traffic ($\mathit{bTr}$).
...
bar width=4pt,
    ...
    \vspace{-1ex}
    \caption{\label{fig:distribution-rules-per-month}Rules per month - 2019.}
\end{figure}% <---- don't forget this %
...
\begin{table}[h!]
  ...
  \begin{tabular}{lrrrrrr}
    ...
    %%Apache Struts 2 & - & - & - & - & - & -\\
    ColdFusion & 3 & 2 & 12 & 5 & 3 \\
    iisadmin access & 1 & 1 & 1 & 8 & 1 \\        
    JBoss JMX & 45 & 5 & 45 & 111 & 45 \\
    Script tag in URI & 1 & 4 & 1 & 8 & 1 \\
    WeBid LFI & 10 & 77 & 28 & 32 & 10 \\    
    %%Wordpress Login & 8 & - & - & - & - \\
    .htaccess access & 2 & 2 & 2 & 17 & 2 \\
    .idq access & 2 & 2 & 2 & 12 & 2 \\
    /system32/ in URI & 4 & 20 & 1 & 58 & 4 \\
    Basebuilder LFI & 34 & 117 & 57 & 183 & 34 \\
    Tomcat Snoop Access & 32 & 828 & 2 & 2564 & 32 \\
    \bottomrule
  \end{tabular}
\end{table}
