...
with content $i$. \Mar{Qual o rationale para considerar as varias
  alternativas de acesso ao inves de apenas a alternativa que eh mencionada?}%% Isto
                                                                             %% nao
                                                                             %% intuitivo
                                                                             %% para
                                                                             %% mim
...
message\Mar{Lucas, a imagem mostrando header com campos Request URI e
  Connection e os conteudos citados acima pode ajudar.}. Consequently,
...
function would be \Fix{...}\Mar{Lucas, confirme que nao esta faltando
  calcular a media (dividir tudo por N).}
