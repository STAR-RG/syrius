...
for the heuristic functions. The sum of $R_i$ rankings of the golden rules, for a set of $N$ 
attacks, is given by $R(W) = \sum_{i=1}^{N}\mathit{R_i}$, where $W = \langle{}w_1, w_2, w_3, w_4\rangle{}$ are the weights considered for each heuristic.
%
