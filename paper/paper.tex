...
\Luc{\textbf{Autonomous Rule Creation for Intrusion Detection} - Usam o Snort e geram regras apenas para pacotes ICMP. O pacote maligno tb eh sabido previamente e, assim como nos, eles identificam todas as opcoes q podem ser usadas para identificar esse pacote. A tecnica proposta utiliza algoritmos geneticos onde a populacao inicial eh formada por regras q combinam aleatoriamente todas essas opcoes. Eles foram capazes de gerar regras q n geram falsos negativos e apenas 3 positivos entre 33k pacotes.}
