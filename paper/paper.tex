...
\tname{} is a technique that uses (1) benign and malicious network
traffic and (2) existing signature-based \nids\ rules to synthesize
new rules. The goal of \tname\ is to create plausible rules that
\emph{only} captures the positive traffic, \ie{}, the malicious
messages.
