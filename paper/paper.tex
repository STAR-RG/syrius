...
\tname{} takes on input one or more examples of an attack, identified by a domain expert, 
and produces on output a ranked list of rules for that attack. It uses public data
...
\percTopFiveRanking\ of the cases. \rui{should we quote the same numbers as in the abstract?}
