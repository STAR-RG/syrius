...
modifiers are applicable for rules of any protocol in Suricatax,
...
most attacks \Mar{Lucas, please confirm.} and (2) the payload of
...
\[\frac{\sum_{i=1}^{N}\sum_{j=1}^{M}\frac{\mathit{modifier\_frequency[modifier_{ij}}]}{\mathit{max(modifier\_frequency)}}}{N}\]

\noindent
, where $N$ is the number of contents in a given rule and $M$ is the
number of content modifiers\Mar{isto eh confuso. vc. esta dizendo que
  ...
  qual o modificador foi escolhido para acessar a string.}. \Luc{M eh
  ...
  content. a frequencia seria 0, correto?}
...
modificadores que estão associadas a esse content.\Mar{nao foi isto
