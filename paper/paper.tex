...
performance. Finally, we used the hping3~\cite{hping3} to reproduce
the Ping Scan icmp attack (see Section~\ref{sec:dos}) as Nikto2 only
supports tcp and http attacks. More precisely, we used the following
hping3 command to reproduce that attack: \CodeIn{hping3 -d 80 -w 512
  -S -p 80 --flood --rand-source <IP>}.
