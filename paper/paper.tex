...
simultaneously enabled (for efficiency). Attackers constantly create
...
\section{Evaluation}
\Luc{Atualmente estamos considerando os seguintes ataques:
\subsection{Ping Scan}
Utilizado para descobrir hosts ativos na rede - pacote individual - protocolo ICMP
\subsection{Port Scan TCP}
Utilizado para descobrir portas abertas em um host - pacote individual - protocolo TCP
\subsection{Port Scan UDP}
Utilizado para descobrir portas abertas em um host - pacote individual - protocolo UDP
\subsection{SYN Flood}
DoS TCP
\subsection{Black Nurse}
DoS ICMP
\subsection{Ping Flood}
DoS ICMP
\subsection{GET/POST Flood}
DoS HTTP
\
}
