...
play a role in the performance of the technique.
...
We answer this question in two parts. Firts, we analyzed the impact of
the amount of positive examples in results. For that, we selected two
cases with the highest number of examples (see column ``\#~Vars'' on
...
\tname\ is sensitive to the number and choice of examples. However, a
small number of positive examples suffices to achieve good results.
\end{tcolorbox}
\end{center}
...
in their original paper. Unfortunately, side comparison was not
