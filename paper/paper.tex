...
example rule of Suricata to detect this attack and alert system
administrators about it, and 3) illustrates how \tname{} performs to
synthesize the corresponding rule.
...
protect against SYN flood attacks.\Fix{explain the structure of the rule.}
